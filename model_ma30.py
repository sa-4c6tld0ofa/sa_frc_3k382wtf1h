...
def get_model_price_ma30(uid, date_str, connection):
    """
...
########################################################################
def set_model_ma30(uid, force_full_update, connection):
    """ xxx """
    ret = 0
    ########################################################################
    ...
    for row in res:
        ...
        if model_tp == 0:
            ...
            ########################################################################
            last_model_tp = get_model_price_ma30(uid, last_date, connection)
