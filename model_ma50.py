...
def get_model_price_ma50(uid, date_str, connection):
    """
    ...
    sql = "SELECT price_close, "+ ma_column_name +" FROM price_instruments_data "+\
...
########################################################################
def set_model_ma50(uid, force_full_update, connection):
    """ xxx """
    ret = 0
    ########################################################################
    ...
    for row in res:
        ...
        if model_tp == 0:
            ...
            ########################################################################
            last_model_tp = get_model_price_ma50(uid, last_date, connection)
