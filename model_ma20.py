...
def get_model_price_ma20(uid,date_str):
    ################################################
    ...
    except Exception as e: debug("get_model_price_ma20() " + str(e) )
    return r
    ...
    try:
        ...
        for row in rs:
            ...
            if model_tp == 0:
                ...
                ########################################################################
                last_model_tp = get_model_price_ma20(uid,last_date)
        ...
        connection.close()
        gc.collect()
    except Exception as e: debug("set_model_ma20() " + str(e) )
    return r
