...
def get_model_7d_trend(uid, date_str, connection):
    """
    ...
    sql = "SELECT price_close, 7dtrend FROM price_instruments_data "+\
...
########################################################################
def set_model_7d_trend(uid, force_full_update, connection):
    """ xxx """
    #-------------------------------------------------------------------
    ret = 0
    ########################################################################
    ...
    for row in res:
        ...
        if model_tp == 0:
            ...
            str(trend_3d_value) +"', 5dtrend = '"+\
            str(trend_5d_value) +"', 7dtrend = '"+ str(trend_7d_value) +\
            ...
            ########################################################################
            last_model_tp = get_model_7d_trend(uid, last_date, connection)
            #-----------------------------------------------------------------------
